...
function wa_paginate_links( $args = '' ) {
...
function wa_bootstrap_pagination( $object, $echo = true ) {
	$big = 999999999; // need an unlikely integer
	$paged = isset($_GET['paged']) ? $_GET['paged'] : 1;
	$pages = wa_paginate_links( array(
	...
	if( is_array( $pages ) ) {
		...
		$pagination = '<nav aria-label="Order Pagination">';
